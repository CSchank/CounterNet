...
updateCounterMsgCounterPlace fsp (CounterMsg counterMsg)  counterPlace =
    (todo "Please implement update function updateCounterMsgCounterPlace for the CounterNet net.", Cmd.none)
